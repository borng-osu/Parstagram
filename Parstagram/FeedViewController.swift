...
class FeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MessageInputBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        center.addObserver(self, selector: #selector(keyboardDisappear(note:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    ...
    func messageInputBar(_ inputBar: MessageInputBar, didPressSendButtonWith text: String) {
        ...
        selected.add(comment, forKey: "comments")
    ...
    @IBAction func onSignOut(_ sender: Any) {
        ...
        let signInView = main.instantiateViewController(withIdentifier: "SignInView")
        
        guard let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene, let delegate = windowScene.delegate as? SceneDelegate else { return }
        
        delegate.window?.rootViewController = signInView
    }
